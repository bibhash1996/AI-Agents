...
import { GRADER_TEMPLATE, ANSWER_GRADER_PROMPT_TEMPLATE } from "./constant";
...
async function invokeRag() {
  ...
  console.log(graphResponse.generatedAnswer);
  return graphResponse.generatedAnswer;
}

invokeRag();

/**
 * NODE_OPTIONS="--loader ts-node/esm" ts-node dsrag.ts
 */
